...
%******     I Les pages          *******
%***************************************
\section[Modèles]{Modèles de pages}
...
\subsection[Normal]{Modèle normal}
% avec l'environnement frame
\begin{frame}[label=pagesimple]
  \frametitle{Modèle banal de page}
...
\end{frame}
% ------------------------------------------------
\subsection[Encadrés]{Les environnements encadrés}
\begin{frame}
\frametitle{Les environnements encadrés}
  \begin{definition}
...
La traduction des titres laisse un peu à désirer.
\end{frame}
...
\frametitle{Les recouvrements}
  ...
  \end{altenv}
  \vfill  
  En faisant défiler assez vite, vous aurez l'impression du clignotement ! 
\end{frame}
% --------------------------------------------------
